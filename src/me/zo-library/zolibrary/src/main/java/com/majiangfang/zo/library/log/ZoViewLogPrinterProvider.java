...
import com.majiangfang.zo.library.util.ZoDisplayUtil;

/**
 * ZoViewLogPrinter的视图提供者，
 */
public class ZoViewLogPrinterProvider {
    ...
    public ZoViewLogPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = ZoDisplayUtil.dp2px(100, rootView.getResources());
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ZoDisplayUtil.dp2px(160, rootView.getResources()));
    ...
    private View genLogView() {
        ...
        TextView closeView = new TextView(rootView.getContext()); //关闭按钮
